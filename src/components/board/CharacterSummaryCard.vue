<template>
  <div
    class="p-2 rounded-md transition-all cursor-pointer shadow-md flex gap-x-2"
    :class="{
      'bg-white hover:bg-gray-100': !isSelected,
      'bg-primary text-white hover:bg-primary-hover': isSelected,
    }"
  >
    <img
